  ...
  render() {
    ...
    return (
      <Layout>
        ...
        <div className="flex items-center justify-center h-screen w-screen bg-gradient-to-br from-white to-gray-300 ">
          <div className="bg-white w-4/6">
            <div className="flex">
              <div className="flex-1 rounded-l-xl">
              ...
              <div className="flex-1 rounded-r-xl red-gradient flex flex-col justify-center items-center text-white">
                <h2 className="text-white text-2xl">Hello, Friend</h2>
                <p className="mx-12">Enter your personal details and start journey with us</p>
