...
const RoundedLoadingButton = ({ className, text, loading, disabled }: IProps) => {
    return (
        <button disabled={disabled} type="submit" className={`bg-primaryOrange text-white rounded-full ${className}`}>
            {loading &&
