...
export class AuthService {
  ...
  public async loginTwitter() {
    ...
    const _twitterConsumerSecret = twitterClientSecret || process.env.TWITTER_CLIENT_SECRET;
    const _twitterCallbackUrl = process.env.SOCIAL_LOGIN_CALLBACK_URL || process.env.USER_URL;
